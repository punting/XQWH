 ...
 */
 ...
 WeixinApi.ready(function(Api) {
    ...
    // 微信分享的数据
    var data = {"imgUrl":"web-1.png","link": linkUrl,"title":"向前文化","desc":"公司介绍"},
        data2 = {"imgUrl":"web-1.png","link": linkUrl,"title":"向前文化","desc":"公司介绍"};
...
$(function(){
    ...
    function typeWrite(){
    	...
    	var typeText = ["名称：向前文化传媒有限公司", $time_val];
    	var delayTime = 150;
		if(!!typer){
			clearInterval(typer);
		}
